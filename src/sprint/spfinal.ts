...
function spis(wrd:word){
     ...
     return `<li class="words"><img src="${serv}/${wrd.image}" class="voice">    <img src="../assets/icons/woman-voice-svgrepo-com.svg" alt="voice" class="voice" audio="${wrd.audio}">  ${wrd.word} - ${wrd.wordTranslate}</li>`
